             ...
             <div className='h-auto w-3/6 flex flex-col rounded-lg border-2 relative items-center gap-y-5 text-2xl justify-center px-8 py-5 bg-slate-100'>
                <h5 className='block text-center text-4xl font-semibold'>Buy Tickets</h5>
                 <div className='my-8'> 
                  ...
                  <button className={`flex items-center p-4 rounded-lg border-2 transition shadow-lg ease-in delay-150 bg-blue-500 hover:-translate-y-1 hover:scale-110 hover:bg-indigo-500 duration-300`} disabled={JWT ? false : true}  onClick={handlePayment}>Buy now</button>
